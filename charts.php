              ...
              <?php
                ...
                if(!empty($_POST)){
                    ...
                    try{
                        ...
                        $sql = "insert into teclado(idTeclado,marca,modelo,estado,fechCompra) values($codMause,'$marca','$modelo','$estado','$fech')";
